        ...
        implements CommandLineRunner
{
            ...
            throws Exception
    {
        ...
        user1.getImages()
                .add(i3);
        Image i2 = new Image(user1, "A Kingfisher Kissing a Pond", "https://static.boredpanda.com/blog/wp-content/uploads/2015/11/perfect-kingfisher-dive-photo-wildlife-photography-alan-mcfayden-311.jpg", false);
        i2 = imgServ.save(i2);
        user1.getImages()
                .add(i2);
        ...
        i4 = imgServ.save(i4);
        Image i5 = new Image(user2, "Shopify Rules!", "https://jordiob.com/amazon-tools/wp-content/uploads/2020/08/shopify-apps.png", true);
        i5 = imgServ.save(i5);
